<!-- Footer Start -->
<div class="container-fluid text-body footer mt-5 pt-5 px-0 wow fadeIn" data-wow-delay="0.1s"  style="background-color: #FFD4D4">
    <div class="container py-5">
        <div class="row g-5">
            ...
            {{-- <div class="col-lg-3 col-md-6">
                <h3 class="text-dark mb-4">Newsletter</h3>
